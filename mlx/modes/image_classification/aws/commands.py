...
class AwsTrainingService(Protocol):
    ...
    def submit(self, infrastructure: AwsInfrastructure, **kwargs) -> AwsTrainingSubmission: ...
...
class SubmitAwsImageClassificationTraining:
    def __init__(self, service: AwsTrainingService) -> None:
        self.service = service

    def execute(self) -> AwsTrainingSubmission:
        return self.service.submit(self.service.prepare_infrastructure())


class ResumeAwsImageClassificationTraining:
...
class GetAwsImageClassificationTrainingStatus:
    def __init__(self, service: AwsTrainingService, job_name: str) -> None:
        self.service = service
        self.job_name = job_name
...
class WatchAwsImageClassificationTraining:
    def __init__(
        self,
...
class StopAwsImageClassificationTraining:
    def __init__(
        self,
        service: AwsTrainingService,
        job_name: str,
