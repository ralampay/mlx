...
class StopAwsTraining:
    def __init__(self, service: AwsTrainingService, job_name: str, *, config_path: str) -> None:
        self.service = service
        self.job_name = job_name
