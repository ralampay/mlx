...
def _render_help() -> None:
    ...
    options.add_row("--train-ratio", "None", "Train split ratio for balanced classification dataset building.")
    options.add_row("--val-ratio", "None", "Validation split ratio for balanced classification dataset building.")
    options.add_row("--test-ratio", "None", "Test split ratio for balanced classification dataset building.")
    options.add_row("--split-mode", "None", "Build-dataset split mode: counts or ratios. Ratio mode derives per-label counts from the smallest label.")
