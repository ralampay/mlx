...
def build_parser() -> RichArgumentParser:
    ...
    parser.add_argument("--names-only", action="store_true", dest="names_only")
    parser.add_argument("--embedding-backend", default="llama-cpp", dest="embedding_backend")
    ...
    parser.add_argument("--model-s3-uri", default=None, dest="model_s3_uri")
...
def _render_help() -> None:
    ...
    options.add_row("--trust-checkpoint-code", "False", "Allow trusted external autoencoder architecture code; never enables unsafe pickle.")
